    ...
    <div class="glass p-10 rounded-3xl w-full max-w-md mx-auto shadow-2xl relative overflow-hidden">
      ...
      <div class="relative z-10">
        ...
        <% if (request.getAttribute("error") !=null) { %>
          <div
            class="bg-red-500/20 border border-red-500/50 text-red-200 px-4 py-3 rounded-xl text-sm mb-6 text-center">
          ...
          <% } %>
            ...
            <form action="signup" method="POST" class="space-y-5">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-400 mb-1.5 ml-1">I am a...</label>
                <select name="role" required
                  class="w-full px-4 py-3 rounded-xl bg-gray-900/50 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all appearance-none cursor-pointer">
                  <option value="STUDENT" class="bg-gray-900 text-white">Student</option>
                  <option value="TEACHER" class="bg-gray-900 text-white">Teacher</option>
                </select>
              </div>
