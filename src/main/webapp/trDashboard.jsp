            ...
            <%@ page import="java.util.List" %>
                <% User user=(User) session.getAttribute("user"); List<Task> teacherTasks = (List<Task>)
                        ...
                        <body class="bg-[#0b0f1a] flex min-h-screen text-gray-200">
                            ...
                            <!-- Sidebar -->
                            <aside
                                class="fixed top-0 left-0 bg-[#0f172a] w-64 min-h-screen border-r border-white/5 z-20">
                                ...
                                <div class="p-10">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                                        <div class="card-glass p-6 rounded-2xl">
                                            <h4 class="text-gray-400 text-sm font-medium mb-1">Your Tasks</h4>
                                            <span class="text-3xl font-bold text-white">
                                                <%= teacherTasks !=null ? teacherTasks.size() : 0 %>
                                            </span>
                                        </div>
                                        <div class="card-glass p-6 rounded-2xl">
                                    ...
                                    <div class="card-glass rounded-2xl p-8">
                                        ...
                                        <div class="space-y-4">
                                            <% if (teacherTasks !=null) { for (Task t : teacherTasks) { %>
                                                <div
                                                    class="flex items-center justify-between py-3 border-b border-white/5">
                                                    <span class="text-sm text-gray-300">Task: <%= t.getTitle() %> (Due:
                                                            <%= t.getDueDate() %>)</span>
                            ...
                            <div id="taskModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
                                <div class="flex items-center justify-center min-h-screen px-4">
                                    ...
                                    <div
                                        class="card-glass relative w-full max-w-lg p-8 rounded-2xl shadow-2xl text-gray-200">
                                        ...
                                        <form action="addTask" method="POST" class="space-y-4">
                                            <div>
                                                <label class="block text-sm font-medium text-gray-400 mb-1">Task
                                                    Title</label>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-gray-400 mb-1">Due
                                                    Date</label>
