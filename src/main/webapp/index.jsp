...
<body class="min-h-screen text-white overflow-x-hidden">
    ...
    <main class="container mx-auto px-6 pt-20 pb-32 flex flex-col items-center text-center relative">
        ...
        <p class="text-lg md:text-xl text-gray-400 max-w-2xl mb-12">
            The next generation Campus announcements management platform for better professional communication.
        </p>
    ...
    <section id="features" class="container mx-auto px-6 py-20">
        <div class="grid md:grid-cols-3 gap-8">
            <div class="p-8 glass rounded-2xl hover:border-blue-500/50 transition-colors">
                ...
                <h3 class="text-xl font-bold mb-4">Principle assignments</h3>
                <p class="text-gray-400">If you are a student you get the principle's and instructors assignment.</p>
            </div>
            <div class="p-8 glass rounded-2xl hover:border-blue-500/50 transition-colors">
                ...
                <h3 class="text-xl font-bold mb-4">Student needs</h3>
                <p class="text-gray-400">As a teacher or a principle you can get what your learners expect from you.</p>
            </div>
            <div class="p-8 glass rounded-2xl hover:border-blue-500/50 transition-colors">
                ...
                <h3 class="text-xl font-bold mb-4">Share ideas</h3>
                <p class="text-gray-400">Principle, teachers and students share ideas for a better campus.</p>
            </div>
        </div>
    </section>
