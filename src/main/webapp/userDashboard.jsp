<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ page import="org.care.cconn.model.User" %>
    <%@ page import="org.care.cconn.model.Announcement" %>
      <%@ page import="org.care.cconn.model.Task" %>
                    ...
                    <main class="ml-64 flex flex-col flex-grow">
                      ...
                      <div class="p-10">
                        <div class="mb-10 flex justify-between items-center">
                          <div>
                            <h1 class="text-4xl font-bold text-white mb-2">Welcome back, <%= user !=null ?
                                user.getUsername() : "Guest" %>!</h1>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                          ...
                          <div class="card-glass p-6 rounded-2xl hover:bg-gray-800/60 transition-all group">
                            ...
                            <div class="flex items-end justify-between">
                              <span class="text-3xl font-bold text-white">
                                <%= announcements !=null ? announcements.size() : 0 %>
                              </span>
                          ...
                          <div class="space-y-4">
                            <div class="card-glass rounded-xl overflow-hidden">
                              <button onclick="toggleAccordion('item1')"
                                ...
                                <svg id="icon-item1" class="w-5 h-5 text-gray-500 transition-transform duration-300"
                              ...
                              <div id="item1"
                                ...
                                C-connect has opened a new headquarters in Kigali, Rwanda to enhance local outreach and
                                ensure smooth
                            ...
                            <div class="card-glass rounded-xl overflow-hidden">
                              <button onclick="toggleAccordion('item2')"
                                ...
                                <svg id="icon-item2" class="w-5 h-5 text-gray-500 transition-transform duration-300"
                                  fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                                </svg>
                              ...
                              <div id="item2"
                                class="px-8 py-5 hidden border-t border-white/5 text-gray-400 leading-relaxed bg-gray-900/20">
                                For over a decade, we have been dedicated to linking junior and senior developers with
                                meaningful career
                    ...
                    <div id="complaintModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
                      <div class="flex items-center justify-center min-h-screen px-4">
                        ...
                        <div class="card-glass relative w-full max-w-lg p-8 rounded-2xl shadow-2xl">
                          ...
                          <form action="addComplaint" method="POST" class="space-y-4">
                            <div>
