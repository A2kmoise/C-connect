<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ page import="org.care.cconn.model.User" %>
    <%@ page import="org.care.cconn.model.Complaint" %>
              ...
              <main class="ml-64 flex flex-col flex-grow">
                ...
                <header
                  ...
                  <div class="flex items-center space-x-6">
                    <div
                      class="w-10 h-10 rounded-full bg-red-600 flex items-center justify-center text-white font-bold">A
                    </div>
                  </div>
                </header>
                ...
                <div class="p-10">
                  ...
                  <div class="card-glass rounded-2xl p-8">
                    ...
                    <div class="space-y-4">
                      <% if (complaints !=null) { for (Complaint c : complaints) { %>
                        <div class="flex items-center justify-between py-3 border-b border-white/5">
                          <span class="text-sm text-gray-300">Complaint: <%= c.getSubject() %> (from <%=
                                c.getStudent().getUsername() %>)</span>
              ...
              <div id="announcementModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
                <div class="flex items-center justify-center min-h-screen px-4">
                  ...
                  <div class="card-glass relative w-full max-w-lg p-8 rounded-2xl shadow-2xl text-gray-200">
                    ...
                    <form action="addAnnouncement" method="POST" class="space-y-4">
                      <div>
